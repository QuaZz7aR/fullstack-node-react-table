    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
      ...
      <div>
        ...
        <input
          ...
          {...register('first_name', { required: 'Required', minLength: { value: 2, message: 'Min 2 characters' } })}
        />
      ...
      <div>
        ...
        <input
          className="w-full border rounded px-2 py-1 text-sm"
          {...register('last_name', { required: 'Required', minLength: { value: 2, message: 'Min 2 characters' } })}
        />
      ...
      <div>
        ...
        <input
          type="number"
          className="w-full border rounded px-2 py-1 text-sm"
          {...register('salary', { required: 'Required', valueAsNumber: true, min: { value: 0, message: 'Must be positive' } })}
        />
